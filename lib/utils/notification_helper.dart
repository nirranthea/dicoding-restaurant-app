...
class NotificationHelper {
  ...
  Future<void> showNotification(
    ...
    var titleNotification = "<b>Check out this awesome Restaurant!</b>";
    var titleResto = restaurants.name;
  ...
  void configureSelectNotificationSubject(String route) {
    selectNotificationSubject.stream.listen(
          ...
          var data = Resto.fromJson(json.decode(payload));
          var restaurant = data;
          print(data.toString());
